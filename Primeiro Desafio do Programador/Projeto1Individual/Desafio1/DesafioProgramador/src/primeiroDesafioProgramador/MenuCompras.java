...
public class MenuCompras {
	...
	public int exibeProdutos() {
		String listaProdutos = "==============Digite o número produto a ser selecionado==============\n"
							 + "  N°     Nome                           Quantidade Estoque                Valor\n";
		String design = "                                        ";		
		int escolhaProduto;
		int i = 0;
		for (Produtos produtos : produtoMenu) {			
			...
			listaProdutos = listaProdutos +(i+1)+"° - "+produtos.getNome()+design.substring(tamanhoDesignNome)
											+produtos.getQuantidade()+design.substring(tamanhoDesignPreco)
											+produtos.getPreco()+"\n";
			i = i + 1;
		}
